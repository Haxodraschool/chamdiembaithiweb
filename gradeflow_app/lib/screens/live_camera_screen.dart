...
class _LiveCameraScreenState extends State<LiveCameraScreen>
  ...
  Future<void> _initCamera() async {
    try {
      ...
      // ResolutionPreset.medium → 640×480 (4:3 landscape = 3:4 portrait)
      _ctr = CameraController(cam, ResolutionPreset.medium,
...
class _AzotaOverlayPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Optimized for 3:4 camera aspect ratio
    final sqSize = screenW * 0.2444;
    final marginX = screenW * 0.0000;
    final marginY = screenH * 0.1014;
